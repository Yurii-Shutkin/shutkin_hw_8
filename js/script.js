...
if (userCity === city1 || userCity === city2 || userCity === city3) { // Определяем город/страну пользователя, согласно условиям задачи
    if (userCity === city1) {
...
if (userFavSport === sport1 || userFavSport === sport2 || userFavSport === sport3) { // Определяем любимый вид спорта пользователя
    if (userFavSport === sport1) {
